...
export default function BottomNav() {
  ...
  return (
    <nav style={{
      ...
      // Nav bar sendiri muncul dengan animasi slide up
          ...
          >
            ...
            <Icon
              ...
              style={{
                ...
                transition: 'color 0.15s, stroke-width 0.15s, margin 0.15s',
              }}
            />
            <span style={{ transition: 'color 0.15s' }}>{label}</span>
          </Link>
        )
      })}
    </nav>
